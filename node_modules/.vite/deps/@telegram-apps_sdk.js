  ...
  return Object.assign(
    (...g3) => {
      ...
      if (U3)
        throw new Z3(`${_2} ${U3}`);
      if (!Xt()) {
        const un = r2 && r2() ? "mounting. Wait for the mount completion" : `unmounted. Use the ${a3}.mount() method`;
...
var [
  ...
  (e) => {
    const t = c3() && T(re2);
    return t ? m.resolve(t) : Wn({ abortSignal: e }).then(ct);
  },
  (e) => {
    X2(it, xo), ve3(e);
  }
...
var Wo = de3("getKeys", (e) => W3("getStorageKeys", {}, e).then(
  (t) => parse(array(string()), t)
));
var yr = de3("setItem", (e, t, o) => W3("saveStorageValue", {
  key: e,
  value: t
}, o).then());
var Br = de3("clear", (e) => Wo(e).then(zo));
...
function Fr() {
  const e = Se2();
  Qo.set(e.tgWebAppData), Lr.set(Be());
}
...
var [
  ...
  (e) => {
    const t = c3() && T(J3);
    return t ? m.resolve(t) : d2("web_app_check_location", "location_checked", e).then(aa);
  },
  (e) => {
    be3.set(e), w(J3, e);
  }
...
var di = c4(() => vt.any.some((e) => z3(e, O3())));
var yt = (e) => {
...
var Bt = (e) => {
  [
    ...
    (o !== D2 || s !== "bg_color" && s !== "secondary_bg_color")) {
      const n = e[s];
      n && i2(o, { color: n });
    }
  });
...
var fi = Oe2(
  ...
  (e) => {
    ...
    return e || (e = (n) => `--tg-${y2(n)}`), s(e("bgColor"), $t), s(e("bottomBarColor"), Mt), s(e("headerColor"), ms), t(() => {
      Ue.set(false);
    }), Ue.set(true), o;
  }
);
...
function Ni(e) {
  ...
  const { onCaptured: t, text: o, capture: s } = e, [, n] = L(
    ...
    X2(qi, (a3) => {
      t ? t(a3.data) : (!s || s(a3.data)) && (r2.resolve(a3.data), i2($s));
    })
  ), r2 = new R(e);
  return (e.postEvent || i2)(Vt, { text: o }), m.resolve(r2).catch(qo).finally(n);
}
var [
  Hi,
  Li,
...
function Nt(e) {
  e !== co() && (i2(xe2, { is_visible: e }), w(De3, e), co.set(e));
}
var pc = Dt(
  "onClick",
  (e) => X2(Bs, e)
...
function Ht(e, t) {
  (e !== et() || t) && (i2(Ne2, { allow_vertical_swipe: e }), w(He2, e), et.set(e));
}
function wc() {
  ue3.set(false);
}
...
var [
  ...
  (e) => {
    X2(Ft, Us), X2(Lt, Gs), X2(Rt, zs), X2(jt, Ws), Y4(e);
  }
);
var kc = ks("mount", yc);
var [, Qs, Oc] = Bc;
...
var [
  ...
  Qc,
  Kc
] = b3((e) => d2(Zs, "emoji_status_access_requested", e).then((t) => t.status), "Emoji status access request is already in progress");
var al = p3(
...
var [
  ...
  (e, t) => d2(Js, ["emoji_status_set", "emoji_status_failed"], {
    params: {
      custom_emoji_id: e,
      duration: (t || {}).duration
    },
...
var [
  ...
  tu,
  ou
] = b3((e) => d2(sn, "home_screen_checked", e).then((t) => t.status || "unknown"), "Check home screen status request is currently in progress");
...
var [
  ...
  uu,
  lu
] = b3((e) => d2(nn, "phone_requested", e).then((t) => t.status), "Phone access request is currently in progress");
...
var [
  ...
  (e) => d2(an, "write_access_requested", e).then((t) => t.status),
